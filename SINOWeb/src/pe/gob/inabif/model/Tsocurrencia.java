...
public class Tsocurrencia  implements java.io.Serializable {
    ...
    public Tsocurrencia(long idocurrencia, int idestado, int idsubcategoria, String ocufechaocurrencia, String ocuresidente, String ocunumeroexpediente, String ocudetalle, int ocuestado, String ocunocorresponde,Long usuregistra, Date fecharegistra, Long usuactualiza, Date fechaactualiza, Long usuelimina, Date fechaelimina) {
       this.idocurrencia = idocurrencia;
